extension AddressValidationExtensions on String {
  ...
  bool get hasStreetNumber => RegExp(r'^\d+\s|#\d+|\d+[a-zA-Z]?\s').hasMatch(this);
  bool get hasStreetName {
    const streetTypes = [
      'street', 'st', 'avenue', 'ave', 'road', 'rd', 'lane', 'ln',
      'drive', 'dr', 'court', 'ct', 'place', 'pl', 'way', 'blvd',
      'boulevard', 'circle', 'cir', 'square', 'sq'
    ];
  ...
  bool get hasCountry {
    const commonCountries = [
      'usa', 'canada', 'uk', 'united states', 'united kingdom',
